...
public class DrosjeloyveServiceContextTextTemplate : IServiceContextTextTemplate<LocalizedString>
{
    ...
    {
        NoNb = $"{TextMacros.RequestorName} har sendt en forespørsel om fullmakt til å hente ut skatteattest og konkursattest for din virksomhet. For at {TextMacros.RequestorName} skal kunne behandle din søknad om drosjeløyve, må du gi fullmakt til å hente ut disse attestene for {TextMacros.SubjectName}. <br><br>Klikk på lenken under for å få vite mer om hvilke opplysninger løyvemyndigheten spør etter. <br></br> Dersom du ikke vil gi fullmakt til at løyvemyndigheten henter opplysninger om foretakets økonomiske evne eller trekker en gitt fullmakt, men likevel ønsker å søke om drosjeløyve, må du sende søknaden med vedlegg per post til din fylkeskommune.​<br><br>  {TextMacros.Button}",
        NoNn = $"{TextMacros.RequestorName} har sendt ein førespurnad om fullmakt til å hente ut skatteattest og konkursattest for verksemda di. For at {TextMacros.RequestorName} skal kunne handsame søknaden din om drosjeløyve, må du gje fullmakt til å hente ut desse attestane for {TextMacros.SubjectName}. <br><br>Klikk på lenka under for å få vite meir om kva slags opplysingar løyvestyresmakta spør etter. <br></br> Dersom du ikkje vil gje fullmakt til at løyvestyremakta hentar opplysingar om den økonomiske evna til føretaket eller trekker ein fullmakt som er gjeve, men likevel ønskjer å søke om drosjeløyve, må du sende søknaden med vedlegg per post til din fylkeskommune.​<br><br>  {TextMacros.Button}",
    };

    public LocalizedString CorrespondenceBodyA3 => new()
    {
        NoNb = $"{TextMacros.RequestorName} har sendt en forespørsel om fullmakt til å hente ut skatteattest og konkursattest for din virksomhet. For at {TextMacros.RequestorName} skal kunne behandle din søknad om drosjeløyve, må du gi fullmakt til å hente ut disse attestene for {TextMacros.SubjectName}.\n\nKlikk på lenken under for å få vite mer om hvilke opplysninger løyvemyndigheten spør etter.\n\nDersom du ikke vil gi fullmakt til at løyvemyndigheten henter opplysninger om foretakets økonomiske evne eller trekker en gitt fullmakt, men likevel ønsker å søke om drosjeløyve, må du sende søknaden med vedlegg per post til din fylkeskommune.​\n\n{TextMacros.Button}",
        NoNn = $"{TextMacros.RequestorName} har sendt ein førespurnad om fullmakt til å hente ut skatteattest og konkursattest for verksemda di. For at {TextMacros.RequestorName} skal kunne handsame søknaden din om drosjeløyve, må du gje fullmakt til å hente ut desse attestane for {TextMacros.SubjectName}.\n\nKlikk på lenka under for å få vite meir om kva slags opplysingar løyvestyresmakta spør etter.\n\nDersom du ikkje vil gje fullmakt til at løyvestyremakta hentar opplysingar om den økonomiske evna til føretaket eller trekker ein fullmakt som er gjeve, men likevel ønskjer å søke om drosjeløyve, må du sende søknaden med vedlegg per post til din fylkeskommune.​\n\n{TextMacros.Button}",
    };
