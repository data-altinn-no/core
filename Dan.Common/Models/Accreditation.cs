...
public class Accreditation
{
    ...
    public EvidenceStatusCode AggregateStatus { get; set; }
    ...
    [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
    public List<EvidenceCode> EvidenceCodes { get; set; }
    ...
    [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
    public Dictionary<string, Requirement> SkippedEvidenceCodes { get; set; }
    ...
    [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
    [Hidden]
    public List<DataRetrieval> DataRetrievals { get; set; }
